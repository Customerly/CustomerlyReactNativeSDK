  ...
  useImperativeHandle(
    ...
    () =>
      ({
        ...
        setOnChatClosed: (callback: CustomerlyCallbacks["onChatClosed"]) => registerCallback("onChatClosed", callback),
        setOnChatOpened: (callback: CustomerlyCallbacks["onChatOpened"]) => registerCallback("onChatOpened", callback),
