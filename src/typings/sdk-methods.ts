...
export type SdkMethods = {
  ...
  setOnMessageRead: (callback: CustomerlyCallbacks["onMessageRead"]) => void;
  setOnMessengerInitialized: (callback: CustomerlyCallbacks["onMessengerInitialized"]) => void;
  setOnMessengerLoadFailed: (callback: CustomerlyCallbacks["onMessengerLoadFailed"]) => void;
  ...
  removeOnMessageRead: () => void;
  removeOnMessengerInitialized: () => void;
  removeOnMessengerLoadFailed: () => void;
